...
public class TeleportInput : MonoBehaviour
{
    ...
    void FindInstances()
    {
        if(PlayerManager.instance.playerInstance != null || PlayerManager.instance.cameraInstance != null)
        {
            player = PlayerManager.instance.playerInstance;
            playerCamera = PlayerManager.instance.cameraInstance;
        }
        else
        {
            PlayerManager.instance.setInstances();
            return;
        }
    }
